...
class BaseIntegrationTool(ABC):
    ...
    def __init__(self, wise_api: WiseAPI, method: str, name: str = "", description: str = "", args_schema: Optional[Type[BaseModel]] = None):
...
class BaseIntegrationToolkit(ABC):
    ...
    def __init__(self, api_key: str, host: str = "https://api.sandbox.transferwise.tech", configuration: Optional[Configuration] = None):
